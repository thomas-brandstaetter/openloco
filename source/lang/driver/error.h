...
namespace lang {
    ...
    public:
        static Error make_error(error_type type, class File& file);
        static Error make_custom_error(std::string &message, class File& file);
        static Error make_scanner_error(std::string &message, class File& file);
